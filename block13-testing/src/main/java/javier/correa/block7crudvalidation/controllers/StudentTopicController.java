...
public class StudentTopicController {
    ...
    public ResponseEntity<StudentWithTopicsOutputDto> getStudentWithTopics(@PathVariable int idStudent) {
        return new ResponseEntity<>(studentTopicService.getListOfTopicByStudent(idStudent), HttpStatus.OK);
    }
    @DeleteMapping("/{id}")
