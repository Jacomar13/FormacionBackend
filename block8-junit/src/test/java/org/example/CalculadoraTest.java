...
class CalculadoraTest {
    ...
    @Test
    public void ejemploNot2() {

        assertThat("cadena", is(not("cadena")));// Falla
    ...
    @Test
    public void ejemploSameInstance2() {
    ...
    @Test
    public void ejemploStartsWith2() {
    ...
    public void ejemploBlankOrNullString() {
        ...
        assertThat(third, blankOrNullString());//Falla
